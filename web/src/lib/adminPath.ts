...
// standalone deploy; a consumer embedding this admin source under a different
// mount can override NEXT_PUBLIC_ADMIN_BASE_PATH at build time (NEXT_PUBLIC_*
// vars are inlined at compile time, same mechanism as the Firebase config vars).
//
