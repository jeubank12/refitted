 ...
 * is refitted's own default (/admin); a consumer mounting this admin UI under
 * a different path declares its own matcher locally instead. Everything else
 * in this file uses ADMIN_BASE_PATH and is shared.
 */
export const config = {
  matcher: ['/admin/:path*'],
}
